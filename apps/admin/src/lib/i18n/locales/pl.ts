...
export const pl: Resources = {
  ...
  overview: {
    ...
    "topCustomers": {
      ...
      "empty": "Brak klientów z zamówieniami."
    },
    "dateRange": {
  ...
  analytics: {
    title: "Analityka",
    subtitle: "Wskaźniki finansowe, zamówienia i doświadczenie użytkownika.",
    tabs: {
      financial: "Finanse",
      orders: "Zamówienia",
      experience: "Doświadczenie użytkownika",
    },
    empty: "Brak danych za ten okres",
    emptyShort: "Brak danych",
    financial: {
      revenuePaid: "Przychód (opłacone)",
      revenuePaidSub: "{{count}} opłaconych zamówień",
      aov: "Śr. wartość zamówienia",
      aovSub: "Na opłacone zamówienie",
      orders: "Zamówienia",
      ordersSub: "W wybranym okresie",
      discounts: "Udzielone rabaty",
      discountsSub: "Lojalność + promocje",
      revenueOverTime: "Przychód w czasie",
      revenueByStatus: "Przychód wg statusu",
      total: "łącznie",
      topProducts: "Najlepsze produkty wg przychodu",
      granularity: { daily: "Dziennie", weekly: "Tygodniowo", monthly: "Miesięcznie" },
    },
    ordersTab: {
      totalOrders: "Wszystkie zamówienia",
      fulfillment: "Wskaźnik realizacji",
      fulfillmentSub: "Dostarczone / wszystkie",
      cancellation: "Wskaźnik anulowań",
      cancellationSub: "Anulowane / wszystkie",
      aov: "Śr. wartość zamówienia",
      overTime: "Zamówienia i przychód w czasie",
      statusDistribution: "Rozkład statusów",
      ordersCenter: "Zamówienia",
      byStatus: "Zamówienia wg statusu",
    },
  },
  analyticsKpi: {
    revenue: "Przychód",
  ...
  orders: {
    ...
    filters: {
      search: "Szukaj",
      searchPlaceholder: "Nr zamówienia lub nazwa klienta...",
      status: "Status",
      allStatuses: "Wszystkie statusy",
      dateRange: "Zakres dat",
      datePlaceholder: "Filtruj po dacie...",
      amount: "Kwota",
    },
    status: {
      pending: "Oczekujące",
    ...
    payment: {
      ...
      failed: "Nieudane",
      refunded: "Zwrócone",
      partially_refunded: "Częśc. zwrot",
    },
    guest: "Gość",
    registered: "Zarejestrowany",
    insights: { statusBreakdown: "Podział statusów" },
    itemsCount: "{{count}} szt.",
    bulk: {
      selected: "Zaznaczono: {{count}}",
      placeholder: "Akcja zbiorcza...",
      markProcessing: "Oznacz: w realizacji",
      markShipped: "Oznacz: wysłane",
      markDelivered: "Oznacz: dostarczone",
      cancel: "Anuluj",
    },
    ...
    errors: {
      load: "Nie udało się załadować zamówień",
      updateStatus: "Nie udało się zmienić statusu",
    },
  },
  orderDetail: {
    back: "Wstecz",
    loading: "Ładowanie zamówienia…",
    notFound: "Nie udało się załadować zamówienia",
    orderNo: "Zamówienie {{number}}",
    itemsTitle: "Pozycje zamówienia",
    col: { product: "Produkt", price: "Cena", qty: "Ilość", total: "Razem" },
    summary: { subtotal: "Suma częściowa", discount: "Rabat", shipping: "Wysyłka", tax: "Podatek", total: "Razem" },
    timelineTitle: "Historia zamówienia",
    steps: {
      pending: "Zamówienie złożone",
      paid: "Płatność otrzymana",
      processing: "W realizacji",
      shipped: "Wysłane",
      delivered: "Dostarczone",
      cancelled: "Anulowane",
    ...
    tracking: {
      ...
      adding: "Dodawanie…",
      none: "Brak informacji o śledzeniu.",
    },
    summaryCard: { title: "Podsumowanie zamówienia", orderId: "Nr zamówienia", date: "Data", paymentMethod: "Metoda płatności" },
    statusTitle: "Zmień status",
    customer: { title: "Klient", guest: "Zamówienie gościa" },
    ...
    payment: {
      ...
      refunded: "Zwrócono",
      paidAt: "Opłacono",
      issueRefund: "Zwróć środki",
      refundTitle: "Zwrot środków",
      refundDesc: "Zwrot za zamówienie {{number}}. Puste pole = pełny zwrot.",
      refundAmount: "Kwota zwrotu (zł)",
      fullRefund: "Pełny zwrot: {{amount}} zł",
      cancel: "Anuluj",
  ...
  customers: {
    "title": "Klienci",
    "subtitle": "Wszyscy, którzy robią zakupy w sklepie — osobno od kont pracowników.",
    "count": "{{count}} klientów",
    "empty": "Nie znaleziono klientów.",
    "kpi": {
      "total": "Wszyscy klienci",
      "newThisMonth": "{{count}} dołączyło w ciągu 30 dni",
      "buyers": "Klienci płacący",
      "wholesale": "{{count}} hurtowych",
      "revenue": "Przychód od klientów",
      "fromCustomers": "Łączne opłacone wydatki",
      "avgSpend": "Śr. wydatek",
      "perBuyer": "Na płacącego klienta"
    },
    "type": {
      "RETAIL": "Detal",
      "WHOLESALE": "Hurt"
    ...
    "filters": {
      "searchPlaceholder": "Szukaj po nazwisku, e-mailu, telefonie…",
      "allTypes": "Wszystkie typy"
    },
    "sort": {
      "spent": "Najwięcej wydali",
      "orders": "Najwięcej zamówień",
      "recent": "Ostatnio zamawiali",
      "joined": "Najnowsi",
      "name": "Nazwa (A–Z)"
    },
    "columns": {
    ...
    "pagination": {
      "showing": "Wyświetlono {{from}}–{{to}} z {{total}}",
      "previous": "Poprzednia",
      "next": "Następna",
    ...
    "detail": {
      ...
      "paidOrdersCount": "{{count}} opłaconych zamówień",
      "itemsBought": "{{count}} kupionych sztuk",
      "aov": "Śr. wartość zamówienia",
      "perPaidOrder": "Na opłacone zamówienie",
      "lastOrder": "Ostatnie zamówienie",
      "memberSince": "Klient od",
      "memberSinceShort": "Dołączył {{date}}",
      "spendOverTime": "Wydatki w czasie",
      "noOrders": "Brak zamówień",
      "ordersByStatus": "Zamówienia wg statusu",
      "loyalty": "Lojalność i ceny",
      "effectiveDiscount": "Efektywny rabat",
      "wholesalePricing": "Ceny hurtowe",
      "tierReached": "Osiągnięty poziom",
      "noTier": "Brak poziomu",
      "wholesaleNote": "Klienci hurtowi otrzymują ceny progowe zależne od ilości, a nie rabat lojalnościowy.",
      "toNextTier": "Jeszcze {{amount}}, aby odblokować {{percent}}%",
      "topTier": "Najwyższy osiągnięty poziom.",
      "spendToUnlock": "Wydaj więcej, aby odblokować pierwszy poziom lojalności.",
      "discountHint": "Rabat jest naliczany automatycznie przy kasie na podstawie łącznych opłaconych wydatków.",
      "personalDiscount": "Rabat indywidualny",
      "personalDiscountPlaceholder": "np. 10",
      "personalDiscountHint": "Zastępuje próg lojalnościowy, gdy jest wyższy. Dotyczy zamówień detalicznych.",
      "saveDiscount": "Zapisz",
      "savingDiscount": "Zapisywanie…",
      "discountSaved": "Rabat zapisany.",
      "discountError": "Nie udało się zapisać rabatu.",
      "recentOrders": "Ostatnie zamówienia",
      "addresses": "Adresy",
      "default": "Domyślny",
      "noAddresses": "Brak zapisanych adresów.",
      "profile": "Profil",
      "email": "E-mail",
      "phone": "Telefon",
  ...
  users: {
    "title": "Użytkownicy",
    "teamTitle": "Zespół",
    "teamSubtitle": "Konta pracowników i administratorów z dostępem do panelu.",
