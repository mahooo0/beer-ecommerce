...
export const pl: Resources = {
  ...
  pages: {
    ...
    empty: "Brak stron.",
    edit: "Edytuj",
    analytics: { title: "Strony", total: "Wszystkie" },
    ...
    blocks: { content: "Tekst", form: "Formularz" },
    errors: { titleRequired: "Tytuł (PL) jest wymagany", layoutRequired: "Dodaj co najmniej jeden blok (PL)", saveFailed: "Nie udało się zapisać strony" },
  },
  blogPost: {
