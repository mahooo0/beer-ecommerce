...
export const en = {
  ...
  overview: {
    ...
    "topCustomers": {
      "title": "Top customers",
      "viewAll": "View all",
      "empty": "No customers with orders yet."
    },
    "dateRange": {
      "last7d": "Last 7d",
      "last30d": "Last 30d",
  ...
  pages: {
    ...
    sections: {
      basics: "Basics",
      basicsHint: "Page title and URL slug.",
      layoutHint: "Build the page from content, media and form blocks.",
      seo: "SEO",
      seoHint: "Optional overrides for search engines and social previews.",
    },
    ...
    blocks: { content: "Text", media: "Image", form: "Form" },
    errors: {
      titleRequiredPl: "Title (PL) is required",
      titleRequiredUk: "Title (UK) is required",
      layoutRequiredPl: "Add at least one block (PL)",
      layoutRequiredUk: "Add at least one block (UK)",
  ...
  analytics: {
    title: "Analytics",
    subtitle: "Financial, orders and user-experience insights.",
    tabs: {
      financial: "Financial",
      orders: "Orders",
    ...
    financial: {
      ...
      revenuePaidSub: "{{count}} paid orders",
      aov: "Avg. order value",
      aovSub: "Per paid order",
      orders: "Orders",
      ordersSub: "In selected period",
      discounts: "Discounts given",
      discountsSub: "Loyalty + promos",
    ...
    ordersTab: {
      ...
      fulfillmentSub: "Delivered / total",
      cancellation: "Cancellation rate",
      cancellationSub: "Cancelled / total",
      aov: "Avg. order value",
      overTime: "Orders & revenue over time",
  ...
  orderDetail: {
    ...
    notFound: "Failed to load order",
    orderNo: "Order {{number}}",
    itemsTitle: "Order Items",
    col: { product: "Product", price: "Price", qty: "Qty", total: "Total" },
    summary: { subtotal: "Subtotal", discount: "Discount", shipping: "Shipping", tax: "Tax", total: "Total" },
    ...
    tracking: {
      ...
      adding: "Adding…",
      none: "No tracking information yet.",
    },
    summaryCard: { title: "Order Summary", orderId: "Order ID", date: "Date", paymentMethod: "Payment method" },
    statusTitle: "Update status",
    customer: { title: "Customer", guest: "Guest checkout" },
    ...
    payment: {
      ...
      refundDesc: "Refund for order {{number}}. Leave amount empty for a full refund.",
      refundAmount: "Refund amount (zł)",
      fullRefund: "Full refund: {{amount}} zł",
      cancel: "Cancel",
  ...
  cartAnalytics: {
    tab: "Carts",
    empty: "No behavioral data for the selected period yet.",
    kpi: {
      conversion: "Conversion rate",
      conversionHint: "Purchases ÷ add-to-cart",
      abandonedCheckouts: "Abandoned checkouts",
      abandonedCarts: "Abandoned carts",
      recoverable: "recoverable",
      purchases: "Purchases",
      purchasesHint: "Completed orders in range",
    },
    funnel: {
      title: "Funnel",
    ...
    abandonedCheckouts: {
      ...
      subtitle: "Reached checkout, no payment within 1 h.",
      empty: "No abandoned checkouts.",
    },
    abandonedCarts: {
      title: "Abandoned carts",
      subtitle: "Items added, no checkout within 24 h.",
    ...
    topViewed: { title: "Most viewed products", empty: "No product views yet." },
    topSearches: { title: "Top searches", empty: "No searches yet." },
  },
  loyaltyTiers: {
    title: "Loyalty Tiers",
    add: "Add Tier",
  ...
  customers: {
    "title": "Customers",
    "subtitle": "Everyone who shops in your store — kept separate from staff accounts.",
    "count": "{{count}} customers",
    "empty": "No customers found.",
    "kpi": {
      "total": "Total customers",
      "newThisMonth": "{{count}} joined in the last 30 days",
      "buyers": "Paying customers",
      "wholesale": "{{count}} wholesale",
      "revenue": "Customer revenue",
      "fromCustomers": "Lifetime paid spend",
      "avgSpend": "Avg. spend",
      "perBuyer": "Per paying customer"
    },
    "type": {
      "RETAIL": "Retail",
      "WHOLESALE": "Wholesale"
    ...
    "detail": {
      ...
      "itemsBought": "{{count}} items bought",
      "aov": "Avg. order value",
      "perPaidOrder": "Per paid order",
      "lastOrder": "Last order",
      "memberSince": "Member since",
      "memberSinceShort": "Joined {{date}}",
      "spendOverTime": "Spend over time",
      "noOrders": "No orders yet",
      "ordersByStatus": "Orders by status",
      "loyalty": "Loyalty & pricing",
      "effectiveDiscount": "Effective discount",
      "wholesalePricing": "Wholesale pricing",
      "tierReached": "Tier reached",
      "noTier": "No tier yet",
      "wholesaleNote": "Wholesale customers get quantity-based tier pricing on the catalog, not a loyalty discount.",
      "toNextTier": "{{amount}} more to unlock {{percent}}%",
      "topTier": "Highest tier reached.",
      "spendToUnlock": "Spend more to unlock the first loyalty tier.",
      "discountHint": "Discount is applied automatically at checkout from lifetime paid spend.",
      "personalDiscount": "Personal discount",
      "personalDiscountPlaceholder": "e.g. 10",
      "personalDiscountHint": "Overrides the loyalty tier when higher. Applied to retail checkout.",
      "saveDiscount": "Save",
      "savingDiscount": "Saving…",
      "discountSaved": "Discount saved.",
      "discountError": "Couldn't save the discount.",
      "recentOrders": "Recent orders",
      "addresses": "Addresses",
      "default": "Default",
      "noAddresses": "No addresses on file yet.",
      "profile": "Profile",
      "email": "Email",
      "phone": "Phone",
  ...
  users: {
    "title": "Users",
    "teamTitle": "Team",
    "teamSubtitle": "Staff and admin accounts with dashboard access.",
    "addUser": "Add User",
