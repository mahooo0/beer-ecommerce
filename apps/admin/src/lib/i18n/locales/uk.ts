...
export const uk: Resources = {
  nav: {
    ...
    section: {
      sales: "Продажі",
      customers: "Клієнти та маркетинг",
      content: "Контент",
      ops: "Операції",
    },
  },
  ...
  overview: {
    ...
    "topCustomers": {
      ...
      "empty": "Ще немає клієнтів із замовленнями."
    },
    "dateRange": {
  ...
  analytics: {
    title: "Аналітика",
    subtitle: "Фінансові показники, замовлення та досвід користувача.",
    tabs: {
      financial: "Фінанси",
      orders: "Замовлення",
    ...
    emptyShort: "Немає даних",
    financial: {
      revenuePaid: "Дохід (оплачено)",
      revenuePaidSub: "{{count}} оплачених замовлень",
      aov: "Середній чек",
      aovSub: "На оплачене замовлення",
      orders: "Замовлення",
      ordersSub: "За вибраний період",
      discounts: "Надані знижки",
      discountsSub: "Лояльність + промо",
      revenueOverTime: "Дохід у часі",
      revenueByStatus: "Дохід за статусом",
      total: "усього",
      topProducts: "Топ товарів за доходом",
      granularity: { daily: "Щодня", weekly: "Щотижня", monthly: "Щомісяця" },
    },
    ordersTab: {
      totalOrders: "Усього замовлень",
      fulfillment: "Рівень виконання",
      fulfillmentSub: "Доставлено / усього",
      cancellation: "Рівень скасувань",
      cancellationSub: "Скасовано / усього",
      aov: "Середній чек",
      overTime: "Замовлення та дохід у часі",
      statusDistribution: "Розподіл статусів",
      ordersCenter: "Замовлення",
      byStatus: "Замовлення за статусом",
    },
  },
  analyticsKpi: {
    revenue: "Дохід",
  ...
  orders: {
    ...
    view: { list: "Список", board: "Дошка" },
    stats: {
      totalOrders: "Усього замовлень",
      revenue: "Дохід",
      pending: "Очікують",
      avgOrderValue: "Сер. чек",
    },
    filters: {
      search: "Пошук",
      searchPlaceholder: "№ замовлення або ім'я клієнта...",
      status: "Статус",
      allStatuses: "Усі статуси",
      dateRange: "Діапазон дат",
      datePlaceholder: "Фільтр за датою...",
      amount: "Сума",
    },
    status: {
      pending: "Очікує",
    ...
    payment: {
      ...
      failed: "Невдало",
      refunded: "Повернено",
      partially_refunded: "Част. повернення",
    },
    guest: "Гість",
    registered: "Зареєстрований",
    insights: { statusBreakdown: "Розподіл статусів" },
    itemsCount: "{{count}} шт.",
    bulk: {
      selected: "Вибрано: {{count}}",
      placeholder: "Масова дія...",
      markProcessing: "Позначити: в обробці",
      markShipped: "Позначити: відправлено",
      markDelivered: "Позначити: доставлено",
      cancel: "Скасувати",
    },
    ...
    errors: {
      load: "Не вдалося завантажити замовлення",
      updateStatus: "Не вдалося змінити статус",
    },
  },
  orderDetail: {
    back: "Назад",
    loading: "Завантаження замовлення…",
    notFound: "Не вдалося завантажити замовлення",
    orderNo: "Замовлення {{number}}",
    itemsTitle: "Позиції замовлення",
    col: { product: "Товар", price: "Ціна", qty: "К-сть", total: "Сума" },
    summary: { subtotal: "Проміжна сума", discount: "Знижка", shipping: "Доставка", tax: "Податок", total: "Разом" },
    timelineTitle: "Історія замовлення",
    steps: {
      pending: "Замовлення оформлено",
    ...
    tracking: {
      ...
      estDelivery: "Очікувана доставка",
      markShipped: "Позначити відправленим",
      adding: "Додавання…",
      none: "Немає інформації про відстеження.",
    },
    summaryCard: { title: "Підсумок замовлення", orderId: "№ замовлення", date: "Дата", paymentMethod: "Спосіб оплати" },
    statusTitle: "Змінити статус",
    customer: { title: "Клієнт", guest: "Замовлення гостя" },
    ...
    payment: {
      ...
      refundDesc: "Повернення за замовлення {{number}}. Порожнє поле = повне повернення.",
      refundAmount: "Сума повернення (zł)",
      fullRefund: "Повне повернення: {{amount}} zł",
      cancel: "Скасувати",
  ...
  cartAnalytics: {
    tab: "Кошики",
    empty: "Немає даних про поведінку за вибраний період.",
    kpi: {
      conversion: "Коефіцієнт конверсії",
      conversionHint: "Покупки ÷ додавання в кошик",
      abandonedCheckouts: "Покинуті оформлення",
      abandonedCarts: "Покинуті кошики",
      recoverable: "можна повернути",
      purchases: "Покупки",
      purchasesHint: "Завершені замовлення за період",
    },
    funnel: {
      title: "Воронка",
      productViews: "Перегляди товарів",
      addToCart: "Додано в кошик",
      checkoutStarted: "Почато оформлення",
      purchased: "Куплено",
      dropoff: "відтік",
    },
    abandonedCheckouts: {
      title: "Покинуті оформлення",
      subtitle: "Дійшли до оформлення, немає оплати протягом 1 год.",
      empty: "Немає покинутих оформлень.",
    },
    abandonedCarts: {
      title: "Покинуті кошики",
      subtitle: "Додали товари, немає оформлення протягом 24 год.",
      empty: "Немає покинутих кошиків.",
    },
    table: {
      customer: "Клієнт",
      items: "Товари",
    ...
    topViewed: { title: "Найпопулярніші товари", empty: "Ще немає переглядів товарів." },
    topSearches: { title: "Топ запитів", empty: "Ще немає запитів." },
  },
  loyaltyTiers: {
  ...
  customers: {
    "title": "Клієнти",
    "subtitle": "Усі, хто робить покупки в магазині — окремо від облікових записів персоналу.",
    "count": "{{count}} клієнтів",
    "empty": "Клієнтів не знайдено.",
    "kpi": {
      "total": "Усього клієнтів",
      "newThisMonth": "{{count}} приєдналися за 30 днів",
      "buyers": "Клієнти, що платять",
      "wholesale": "{{count}} оптових",
      "revenue": "Дохід від клієнтів",
      "fromCustomers": "Загальні оплачені витрати",
      "avgSpend": "Сер. витрати",
      "perBuyer": "На одного платника"
    },
    "type": {
      "RETAIL": "Роздріб",
      "WHOLESALE": "Опт"
    ...
    "status": {
      "active": "Активний",
      "inactive": "Заблокований"
    },
    "filters": {
      "searchPlaceholder": "Пошук за ім'ям, e-mail, телефоном…",
      "allTypes": "Усі типи"
    },
    "sort": {
      "spent": "Найбільші витрати",
      "orders": "Найбільше замовлень",
      "recent": "Нещодавно замовляли",
      "joined": "Найновіші",
      "name": "Ім'я (А–Я)"
    },
    "columns": {
    ...
    "detail": {
      ...
      "paidOrdersCount": "{{count}} оплачених замовлень",
      "itemsBought": "{{count}} куплених позицій",
      "aov": "Сер. вартість замовлення",
      "perPaidOrder": "На оплачене замовлення",
      "lastOrder": "Останнє замовлення",
      "memberSince": "Клієнт з",
      "memberSinceShort": "Приєднався {{date}}",
      "spendOverTime": "Витрати в часі",
      "noOrders": "Ще немає замовлень",
      "ordersByStatus": "Замовлення за статусом",
      "loyalty": "Лояльність і ціни",
      "effectiveDiscount": "Фактична знижка",
      "wholesalePricing": "Оптові ціни",
      "tierReached": "Досягнутий рівень",
      "noTier": "Немає рівня",
      "wholesaleNote": "Оптові клієнти отримують ціни за кількістю, а не знижку лояльності.",
      "toNextTier": "Ще {{amount}}, щоб відкрити {{percent}}%",
      "topTier": "Найвищий досягнутий рівень.",
      "spendToUnlock": "Витратьте більше, щоб відкрити перший рівень лояльності.",
      "discountHint": "Знижка застосовується автоматично на касі на основі загальних оплачених витрат.",
      "personalDiscount": "Персональна знижка",
      "personalDiscountPlaceholder": "напр. 10",
      "personalDiscountHint": "Замінює рівень лояльності, коли вища. Діє для роздрібного оформлення.",
      "saveDiscount": "Зберегти",
      "savingDiscount": "Збереження…",
      "discountSaved": "Знижку збережено.",
      "discountError": "Не вдалося зберегти знижку.",
  ...
  users: {
    "title": "Користувачі",
    "teamTitle": "Команда",
    "teamSubtitle": "Облікові записи персоналу та адміністраторів з доступом до панелі.",
