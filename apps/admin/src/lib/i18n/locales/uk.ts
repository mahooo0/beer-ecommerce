...
export const uk: Resources = {
  ...
  pages: {
    ...
    edit: "Редагувати",
    analytics: { title: "Сторінки", total: "Усього" },
    ...
    blocks: { content: "Текст", form: "Форма" },
    errors: { titleRequired: "Назва (PL) обов'язкова", layoutRequired: "Додайте хоча б один блок (PL)", saveFailed: "Не вдалося зберегти сторінку" },
  },
  blogPost: {
